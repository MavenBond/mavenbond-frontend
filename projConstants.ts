...
export const NEWAD_FORM_MODEL = [
  ...
  },
  {
    ...
    required: true,
    min: 0,
    placeholder: "Min event price in USD",
  },
  {
    id: "moneyMax",
    registerAs: "moneyMax",
    ...
    required: true,
    min: 0,
    placeholder: "Max event price in USD",
  },

  {
    id: "startDate",
    registerAs: "startDate",
    label: "Start Date",
    tooltip: "",
    type: "date",
    required: true,
